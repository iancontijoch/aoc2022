...
def foo(
    ...
    if point[1] >= floor:
        ...
        return point, False
    # While it is able to move down, move down
    elif grid[down] == '.':
        point = down
    # While it is able to move down-left, move down-left
    elif grid[down_left] == '.':
        point = down_left
    # While it is able to move down-right, move down-right
